...
public class Main {
    ...
    private static Node transformLeftClonedTree(Node node) {
        if (node == null) {
            return null;
        }
    ...
    private static Node transformFromLeftClonedTree(Node node) {
        if (node == null) {
            return null;
        }

        node.left = transformFromLeftClonedTree(node.left.left);
        node.right = transformFromLeftClonedTree(node.right);
        return node;
    }
    ...
    public static void main(String[] args) {
        ...
        root = transformLeftClonedTree(root);
        System.out.println("------------After left cloning------------");
        levelOrderLineWise(root);
        root = transformFromLeftClonedTree(root);
        System.out.println("------------After reversing left cloning------------");
        levelOrderLineWise(root);
    }
}