...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] arr2 = { 10, 20, 50, -1, 60, -1, -1, 30, 70, -1, 80, 110, -1, 120, -1, -1, -1, 40, 100, -1, -1, -1 };
        Node root1 = construct(arr1);
        Node root2 = construct(arr2);
        boolean areSimilar = areTreesSimilar(root1, root2);
        System.out.println("Are trees similar: " + areSimilar);
    }
}